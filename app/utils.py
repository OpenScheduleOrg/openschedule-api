...
def useless_params(params, useful_parameters):
    ...
    if detail:
        raise APIExceptionHandler("Request have parameters worthless.",
                                  detail=detail,
                                  status_code=422)
