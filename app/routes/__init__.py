...
# 400 BAD REQUEST Essa resposta significa que o servidor não entendeu a requisição
# pois está com uma sintaxe inválida.
# 404 NOT FOUND O servidor não encontra o recurso solicitado
# 422 UNPROCESSABLE ENTITY indica que o servidor entende o tipo de conteúdo da
# entidade da requisição, e a sintaxe da requisição esta correta,
...
#    "data": {
#        "detail": {"key": "required" | "not found" | "invalid" | "unusable"},
...
#    "status": "success",
#    "data": {
#        "consultas": [{"consulta data"}, {"consulta data"}] | "consulta": {"new_consulta_data"}
#    }
# }
#
